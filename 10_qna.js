...
function displayPosts(posts) {
    ...
    posts.forEach((post, index) => {
        ...
        row.innerHTML = "<td>" + (index + 1) + "</td><td><a href='10-2_see.html' data-id='" + index + "'>" + post.title + "</a></td><td>" + post.date + "</td><td><button class='delete-button' data-id='" + index + "'>&#10006;</button></td>";
...
function deletePost(id) {
    ...
    if (storedPosts) {
        ...
        localStorage.setItem('qnaPosts', JSON.stringify(posts)); // 변경된 게시물 목록을 저장
